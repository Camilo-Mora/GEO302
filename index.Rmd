...
To use the iStudy app, you need a free Google AI API key. Follow the steps below: 

```{block2, type='rmdtip'}
**Caution:** 
  
If you fail to collect tha API key after following the isntructions below, we came across a couple of issues:

*Restricted Gmail account*: If you see any wording to this fact, try a different account or create a new one in the USA. UH accounts do not work. 


*Suspicius request*: This warning appears in Apple computers with some browsers. Simply use a different browser.

If you follow the instructions below and still fail to get the API, take a screenshot of the website where you hit a roadblock, paste it in [Gemini](https://gemini.google.com/) or [chatGPT](https://chatgpt.com), and write ***"Help me get a Google AI studio API key. I am stuck in the current page. What do I need to do next? Be brief and give me a solution I can do now"***
```
...
2.  **Create a Project:**
    ...
    *   On the popup window, name your project **"GEO302"** and click **"Create project"**.
![](images/GoogleAIStudio.png)

3.  **Generate the Key:**
    *   3.1 Click `Get API key` (bottom left button).
    *   3.2 Click `Create API key`.
    *   On the popup window, select the **GEO302** project you just created.
    *   Click **"Create key"**.
