...
* **The Workflow:**
    ...
    4.  **Submit to iStudy:** Save your answers as a text file (i.e., .txt). Upload that file to the iStudy App (link provided in the Table of Contents on the left sidebar). The iStudy app will provide feedback and query you on your understanding of the content; at the end, it will generate a revised version of your responses for your records. 
    
<br>
```{block2, type='rmdtip'}
**Note**
The iStudy app will check your responses againts the course content, and query you to assess your understanding of the content. Think of it like breaking a final exam into weekly quizzes, without the stress of the final, nor the worry for a grade. The entire Q&A for a given chapter is graded as complete or not complete (see section of "Grading" below).

Istudy will generate a file of the responses based on the course content for your records. The responses will be based on the content to ensure all students end up with the same standard knowledge. Think of it like you are building a weekly coursebook.
```
<br>
...
*   **Submission Rules:**
    ...
    *   **File Type:** A plain text file (`.txt`). 
...
```{block2, type='rmdtip'}
**WARNING**
The iStudy app will download your revised responses to your computer. Save that file as you will need it as proof that you did the work, and as your study guide, if you chooce to take the final video exam.
```
<br>
...
If you choose to take the final video exam, you need to submit excellent videos with all the responses for six chapter for an A-, eight chapters for an A, and 10 chapters for an A+. 
...
After you have watched a video for a given chapter, and collected all your responses in a text file, load them in this app:
